...
public class AcquisitionHandler {
    ...
    public Mono<Acquisition> createAcquisition(Mono<Acquisition> request){
        ...
        return request
                .flatMap(acquisition1 -> productService.findByProductName(acquisition1.getProduct().getProductName())
                .flatMap(product -> {
